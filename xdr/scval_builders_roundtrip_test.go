...
// variants already have dedicated round-trip tests in scval_builders_test.go;
// this fills the gap for the remaining builders that T0.3 calls out as
// "round-tripping known XDR fixtures".
